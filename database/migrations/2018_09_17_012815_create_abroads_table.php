...
class CreateAbroadsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('abroads', function (Blueprint $table) {
            ...
            $table->string('linkman')->default(1)->comment('联系人');
            $table->text('linkman_duties')->nullable()->comment('联系人职务');
            $table->integer('linkman_phone')->default(0)->comment('联系人电话');
            $table->text('reasons_visit')->default(0)->comment('出访事由');
